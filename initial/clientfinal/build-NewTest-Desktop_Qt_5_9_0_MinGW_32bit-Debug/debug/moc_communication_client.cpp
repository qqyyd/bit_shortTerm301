...
void Communication_client::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Communication_client *_t = static_cast<Communication_client *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (Communication_client::*_t)(QString , QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Communication_client::new_string_message_ready)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (Communication_client::*_t)(QVector<PersonalInfo> );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Communication_client::friendList_ready)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (Communication_client::*_t)(QVector<QPair<PersonalInfo,QString>> );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Communication_client::request_recode_ready)) {
                *result = 2;
                return;
            }
        }
        {
            typedef void (Communication_client::*_t)(QVector<QPair<QString,QVector<QString>> > );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Communication_client::chat_recode_ready)) {
                *result = 3;
                return;
            }
        }
        {
            typedef void (Communication_client::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Communication_client::login_feedback)) {
                *result = 4;
                return;
            }
        }
        {
            typedef void (Communication_client::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Communication_client::register_feedback)) {
                *result = 5;
                return;
            }
        }
        {
            typedef void (Communication_client::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Communication_client::find_friend_result)) {
                *result = 6;
                return;
            }
        }
        {
            typedef void (Communication_client::*_t)(PersonalInfo , QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Communication_client::friend_request)) {
                *result = 7;
                return;
            }
        }
        {
            typedef void (Communication_client::*_t)(PersonalInfo );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Communication_client::new_friend_added)) {
                *result = 8;
                return;
            }
        }
        {
            typedef void (Communication_client::*_t)(PersonalInfo );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Communication_client::be_rejected)) {
                *result = 9;
                return;
            }
        }
        {
            typedef void (Communication_client::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Communication_client::head_image_change_state)) {
                *result = 10;
                return;
            }
        }
        {
            typedef void (Communication_client::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Communication_client::usersMotto_change_state)) {
                *result = 11;
                return;
            }
        }
...
const QMetaObject Communication_client::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Communication_client.data,
      qt_meta_data_Communication_client,  qt_static_metacall, nullptr, nullptr}
};
...
void *Communication_client::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Communication_client.stringdata0))
        return static_cast<void*>(const_cast< Communication_client*>(this));
