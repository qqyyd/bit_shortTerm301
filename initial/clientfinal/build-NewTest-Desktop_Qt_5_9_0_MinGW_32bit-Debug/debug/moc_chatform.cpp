...
void ChatForm::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (ChatForm::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ChatForm::ChatFormClosed)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (ChatForm::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ChatForm::enteredText)) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject ChatForm::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_ChatForm.data,
      qt_meta_data_ChatForm,  qt_static_metacall, nullptr, nullptr}
};
