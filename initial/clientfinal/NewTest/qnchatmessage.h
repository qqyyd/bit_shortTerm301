...
class QNChatMessage : public QWidget
{
    Q_OBJECT
public:
    explicit QNChatMessage(QWidget *parent = nullptr,QString friendName="");
...
protected:
    ...
    QPixmap circleAvatar(QPixmap pixmapa);
private:
    QString m_msg;
    QString m_time;
    QString m_curTime;
    ...
    void setLeftAvatar(QImage friendAvatar);
    void setRightAvatar(QImage myAvatar);
